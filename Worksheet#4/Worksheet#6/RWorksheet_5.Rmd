...
The dataset employs a survey scale with a range of 1 to 10 and is centered on women who are coping with breast cancer. 
Cluster thickness, size uniformity, shape uniformity, and other properties of cell nuclei seen in breast cancer are evaluated using this scale. 
